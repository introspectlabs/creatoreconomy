...
const INITIAL_DATA: ProfileData = {
  ...
  username: 'arjunmehta',
  tagline: 'D2C brand founder & AI commerce builder — helping brands sell smarter with AI Sales Agents',
  bio: `I'm a D2C brand founder and AI commerce strategist who has spent 6 years building and scaling direct-to-consumer brands across skincare, nutrition, and lifestyle categories.\n\nI build AI Sales Agents trained on product catalogs, brand voice, and customer FAQs — so D2C brands can automate product discovery, pre-purchase Q&A, and upsell flows without adding headcount.\n\nMy platform powers AI agents for 40+ D2C brands across India and Southeast Asia, driving an average 22% lift in conversion rates and 3x reduction in support costs.`,
  location: 'Mumbai, India',
  website: 'https://arjunmehta.in',
  expertise: [
    'D2C Brand Building & Growth',
  ...
  certifications: [
    { id: '1', name: 'Shopify Partner — Commerce Expert', issuer: 'Shopify', year: '2022', url: '' },
    { id: '2', name: 'Google Cloud AI Practitioner', issuer: 'Google Cloud', year: '2023', url: '' },
    { id: '3', name: 'Meta Business Partner — WhatsApp Commerce', issuer: 'Meta', year: '2023', url: '' },
    { id: '4', name: 'D2C Founders Network — Verified Member', issuer: 'D2C Founders Network', year: '2021', url: '' },
  ],
  socialLinks: [
