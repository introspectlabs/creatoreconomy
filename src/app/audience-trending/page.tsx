...
const TRENDING_PERSONAS: TrendingPersona[] = [
  ...
  { id: '5', name: 'Kai Voice Agent', creator: 'PersonaMatrix', category: 'Voice', emoji: '🎙️', slug: 'kai-voice-agent', description: 'Voice AI IVR replacement with natural language understanding.', followers: '15.6k', growth: '+7%', chatsToday: '520', rating: 4.8, rank: 5, isFollowing: false },
