...
const ALL_PERSONAS: Persona[] = [
  ...
  { id: '4', name: 'Kai Voice Agent', creator: 'PersonaMatrix', category: 'Voice', emoji: '🎙️', slug: 'kai-voice-agent', description: 'SIP-based voice IVR replacement with natural language understanding.', followers: '15.6k', isFollowing: false, rating: 4.8 },
