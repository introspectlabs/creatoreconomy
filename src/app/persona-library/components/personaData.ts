...
export const personas: Persona[] = [
  ...
  },
  {
    ...
    name: 'Sasha Skin',
    slug: 'sasha-skin',
    description: 'D2C brand — recommends products from her clean skincare line, answers ingredient questions, and guides customers to their perfect routine.',
    status: 'active',
    avatar: 'SS',
    channels: ['Web Chat', 'WhatsApp'],
    services: ['ElevenLabs', 'Heygen'],
  ...
  },
  {
    ...
    name: 'Theo Gear',
    slug: 'theo-gear',
    description: 'D2C brand — helps customers choose the right bag, accessories, and workspace setup from his minimalist everyday carry product line.',
    status: 'active',
    avatar: 'TG',
    channels: ['Web Chat'],
    services: ['ElevenLabs'],
