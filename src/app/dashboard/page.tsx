    ...
    <AppLayout>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {metrics?.map((m) => (
          <div
            key={m?.label}
            className="p-4 rounded-2xl border border-white/8 bg-white/[0.03] flex flex-col gap-3"
          >
            ...
            <div>
              ...
              <p className={`text-xs mt-0.5 ${m?.trend === 'up' ? 'text-[#34d399]' : 'text-white/35'}`}>
                {m?.change}
              </p>
            </div>
          </div>
                    ...
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <span
                        className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full border ${
                          p?.status === 'active' ?'bg-[#34d399]/15 text-[#34d399] border-[#34d399]/25' :'bg-white/8 text-white/40 border-white/10'
                        }`}
                      >
                        {p?.status}
                      </span>
