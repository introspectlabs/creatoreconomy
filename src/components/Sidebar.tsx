...
import { LayoutDashboard, Code2, ChevronLeft, ChevronRight, Settings, LogOut, User, ChevronDown, Receipt, BarChart2, Menu, X, Rocket, BookOpen, Users, MessagesSquare, Plus } from 'lucide-react';
